...
import { UserPlus, Shield, Search, GripVertical, Check, ArrowRightLeft } from "lucide-react";
    ...
    <DialogContent className="sm:max-w-[950px] rounded-[2rem] p-6 sm:p-8 bg-white border border-gray-200 shadow-2xl">
      <DialogHeader className="pb-4 border-b border-gray-100">
        <DialogTitle className="text-xl font-extrabold text-gray-900 tracking-tight flex items-center gap-2.5">
          ...
          <div>
            <span>{type} User Account</span>
            <p className="text-xs text-gray-400 font-medium normal-case mt-0.5">
              Isi kredensial akun, data unit institusi, dan kelola jabatan akses pengguna.
            </p>
          </div>
        </DialogTitle>
      </DialogHeader>
          ...
          <div className="md:col-span-5 space-y-5">
            ...
            <div className="p-5 bg-gray-50/50 rounded-2xl border border-gray-100 space-y-4">
              ...
              <FormInput
                ...
                placeholder={type === "Create" ? "Minimal 8 karakter" : "Biarkan kosong untuk mempertahankan password"}
                type="password"
              />
            </div>
              ...
              >
                <div className="flex items-center justify-between mb-3 flex-shrink-0">
                  ...
                  {selectedRoles.length > 0 && (
                    <span className="text-[10px] font-bold text-emerald-600 flex items-center gap-0.5 select-none">
